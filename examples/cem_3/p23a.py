...
def main() -> None:
    ...
    # sigma = 0.1 na região 0 ≤ x ≤ 0.5, caso contrário σ = 0.0
    sigmas = np.where(
    ...
    gauss_sigma = 0.150  # Standard deviation of the Gaussian
    initialField = np.exp(-((sp.x - x0) ** 2) / (2 * gauss_sigma ** 2))
