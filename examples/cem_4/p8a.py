...
PROBLEM = {'name': 'cem_4p8a', 'folder_name': 'cem_4p8', 'description': 'Teste de convergência do esquema DGTD bidimensional TMz.',
    ...
    'm': 1,                     # Número de modo
    'n': 1,                     # Número de modo
    'Lx': np.pi,                # Dimensão total do domínio
    'Ly': np.pi,                # Dimensão total do domínio
