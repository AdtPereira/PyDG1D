...
def run_convergence_rate_study(problem_data) -> pd.DataFrame:
    """
    ...
    # Gráfico
    json_file = Path(__file__).parent.parent.parent / 'examplesData' / 'inputs' / 'hesth_2D_cavity' / 'hesthaven_fig_69a.json'
